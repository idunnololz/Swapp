...
public final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        initFromCameraParameters(camera, width, height);
    }
    ...
    void initFromCameraParameters(Camera camera, int w, int h) {
        ...
        Camera.Size s = getOptimalPreviewSize(parameters.getSupportedPreviewSizes(), w, h);
        cameraResolution = new Point(s.width, s.height);//findBestPreviewSizeValue(parameters, screenResolution, true);
        Log.i(TAG, "Camera resolution: " + cameraResolution);
    }

    Point setDesiredCameraParameters(Camera camera) {
        Camera.Parameters parameters = camera.getParameters();
